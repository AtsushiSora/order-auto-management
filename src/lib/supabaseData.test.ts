...
describe("Supabaseデータ変換", () => {
  ...
  it("顧客台帳と連絡履歴を安全に相互変換する", () => {
    expect(mapCustomerFromDb({
      ...
      display_name: " テスト廃車株式会社 ", last_name: "", first_name: "", kana: "テストハイシャ", birth_date: null, contact_person: "担当者",
    ...
    expect(customerToDb({
      customerId: null, entityType: "個人", category: "一般のお客様", displayName: "", lastName: " 山田 ", firstName: " 太郎 ", kana: " ヤマダ タロウ ",
    ...
    })).toMatchObject({ entity_type: "individual", display_name: "山田 太郎", last_name: "山田", first_name: "太郎", email: "test@example.com", contact_person: "", invoice_registration_number: "" });
