...
export const productionReadinessItems: Array<{
  ...
  { key: "expense_approval", category: "帳簿・経理", title: "スタッフ経費申請", description: "通常スタッフの申請、証憑、事業主承認、入出金連携を確認", targetPage: "expenses", targetLabel: "経費を開く", steps: ["通常スタッフで在庫車を選び、内容・金額・架空の領収書画像を付けて経費を申請する", "事業主で申請内容と証憑を確認し、振込または現金を選んで承認する", "承認後に経費と未払いが重複なく作られ、却下・申請取消も権限どおり操作できることを確認する"] },
  { key: "customer_management", category: "権限・連携", title: "顧客管理", description: "顧客番号、住所補完、契約引き継ぎ、取引履歴を確認", targetPage: "customers", targetLabel: "顧客を開く", steps: ["架空の個人顧客を名字・名前・生年月日・郵便番号で登録し、顧客番号と住所が正しく入ることを確認する", "登録した顧客を買取または販売契約で選び、氏名・住所・連絡先が契約サイトへ引き継がれることを確認する", "契約後に取引履歴が表示され、重要メモは顧客管理画面だけに表示されることを確認する"] },
  { key: "staff_onboarding", category: "権限・連携", title: "スタッフ登録・在籍管理", description: "招待、社員番号、個人情報、休止・退職・削除を確認", targetPage: "settings", targetLabel: "設定を開く", steps: ["架空のメールアドレスへスタッフ招待を行い、パスワード設定後にスタッフ情報を登録する", "登録順の社員番号、氏名・住所・電話・生年月日・免許証情報が事業主だけに修正できることを確認する", "休止・退職ではログインできず、取引履歴のない退職者だけを完全削除できることを確認する"] },
